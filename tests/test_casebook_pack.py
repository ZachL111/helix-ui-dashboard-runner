"""Regression checks for the helix-ui-dashboard-runner casebook."""
...
from casebook.harness import assert_expected, helix_ui_dashboard_runner_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(helix_ui_dashboard_runner_summary(), assert_expected())
